...
public class SpeculativeQuickfixDialog_old extends Dialog implements  SpeculativeListener {
	private Table table;
	 ...
	 */
	public SpeculativeQuickfixDialog_old(Shell parentShell, AnalysisResult analysisResult, Problem problem, List<AtlProblemQuickfix> quickfixes) {
		super(parentShell);
