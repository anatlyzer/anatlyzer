...
public class BindingInvalidTargetInResolvedRule_FilterBinding extends BindingProblemQuickFix {
	...
	private List<MatchedRule> detectGuiltyRules(BindingWithResolvedByIncompatibleRule p, AnalysisResult analysis) {
