...
/**
 * Based on QuickOutlinePopupDialog
 * 
 * @author jesus
 *
 */
public class TransformationOutlineDialog extends PopupDialog implements IInformationControl, IInformationControlExtension, IInformationControlExtension2, DisposeListener {
