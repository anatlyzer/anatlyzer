...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Atl Parse Error</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link anatlyzer.atl.errors.atl_error.impl.AtlParseErrorImpl#getGenericKind <em>Generic Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AtlParseErrorImpl extends LocalProblemImpl implements AtlParseError {
	/**
	...
	protected EClass eStaticClass() {
		return AtlErrorPackage.Literals.ATL_PARSE_ERROR;
	}
	...
	public void setGenericKind(String newGenericKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorPackage.ATL_PARSE_ERROR__GENERIC_KIND, oldGenericKind, genericKind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorPackage.ATL_PARSE_ERROR__GENERIC_KIND:
