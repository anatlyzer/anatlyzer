 ...
 * <ul>
 *   <li>{@link anatlyzer.atl.errors.atl_error.impl.IncoherentVariableDeclarationImpl#getInferred <em>Inferred</em>}</li>
 *   <li>{@link anatlyzer.atl.errors.atl_error.impl.IncoherentVariableDeclarationImpl#getDeclared <em>Declared</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IncoherentVariableDeclarationImpl extends LocalProblemImpl implements IncoherentVariableDeclaration {
	/**
		...
		if (inferred != null && inferred.eIsProxy()) {
			...
			if (inferred != oldInferred) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtlErrorPackage.INCOHERENT_VARIABLE_DECLARATION__INFERRED, oldInferred, inferred));
			}
		}
		return inferred;
	}
	...
	public void setInferred(Type newInferred) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorPackage.INCOHERENT_VARIABLE_DECLARATION__INFERRED, oldInferred, inferred));
	}
	...
	public Type getDeclared() {
		if (declared != null && declared.eIsProxy()) {
			...
			if (declared != oldDeclared) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtlErrorPackage.INCOHERENT_VARIABLE_DECLARATION__DECLARED, oldDeclared, declared));
			}
		}
		return declared;
	}
	...
	public void setDeclared(Type newDeclared) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorPackage.INCOHERENT_VARIABLE_DECLARATION__DECLARED, oldDeclared, declared));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorPackage.INCOHERENT_VARIABLE_DECLARATION__INFERRED:
				if (resolve) return getInferred();
				return basicGetInferred();
			case AtlErrorPackage.INCOHERENT_VARIABLE_DECLARATION__DECLARED:
