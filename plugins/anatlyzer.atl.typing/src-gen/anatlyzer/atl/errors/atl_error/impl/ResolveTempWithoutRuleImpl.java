 ...
 * </p>
 * <ul>
 *   <li>{@link anatlyzer.atl.errors.atl_error.impl.ResolveTempWithoutRuleImpl#getSourceType <em>Source Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResolveTempWithoutRuleImpl extends ResolveTempProblemImpl implements ResolveTempWithoutRule {
	...
	protected EClass eStaticClass() {
		return AtlErrorPackage.Literals.RESOLVE_TEMP_WITHOUT_RULE;
	}
		...
		if (sourceType != null && sourceType.eIsProxy()) {
			...
			if (sourceType != oldSourceType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AtlErrorPackage.RESOLVE_TEMP_WITHOUT_RULE__SOURCE_TYPE, oldSourceType, sourceType));
			}
		}
		return sourceType;
	}
	...
	public void setSourceType(EClass newSourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AtlErrorPackage.RESOLVE_TEMP_WITHOUT_RULE__SOURCE_TYPE, oldSourceType, sourceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AtlErrorPackage.RESOLVE_TEMP_WITHOUT_RULE__SOURCE_TYPE:
