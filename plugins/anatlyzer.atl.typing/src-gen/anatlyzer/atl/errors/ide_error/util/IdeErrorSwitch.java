 ...
 * @generated
 */
public class IdeErrorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IdeErrorPackage.COULD_NOT_LOAD_METAMODEL: {
				CouldNotLoadMetamodel couldNotLoadMetamodel = (CouldNotLoadMetamodel)theEObject;
				T result = caseCouldNotLoadMetamodel(couldNotLoadMetamodel);
				if (result == null) result = caseLocalProblem(couldNotLoadMetamodel);
				if (result == null) result = caseProblem(couldNotLoadMetamodel);
				if (result == null) result = caseAnalysisInfo(couldNotLoadMetamodel);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Could Not Load Metamodel</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Could Not Load Metamodel</em>'.
