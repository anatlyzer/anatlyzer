 ...
 * </p>
 * <ul>
 *   <li>{@link anatlyzer.atl.types.impl.MetaModelImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetaModelImpl extends MinimalEObjectImpl.Container implements MetaModel {
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.META_MODEL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.META_MODEL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.META_MODEL__NAME:
				return getName();
		}
