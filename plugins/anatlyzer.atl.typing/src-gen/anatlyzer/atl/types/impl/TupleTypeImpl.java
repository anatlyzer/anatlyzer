 ...
 * </p>
 * <ul>
 *   <li>{@link anatlyzer.atl.types.impl.TupleTypeImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleTypeImpl extends TypeImpl implements TupleType {
	...
	public EList<TupleAttribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<TupleAttribute>(TupleAttribute.class, this, TypesPackage.TUPLE_TYPE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TypesPackage.TUPLE_TYPE__ATTRIBUTES:
