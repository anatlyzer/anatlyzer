 ...
 * @generated
 */
public class OCL2AdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected OCL2Switch<Adapter> modelSwitch =
		new OCL2Switch<Adapter>() {
			@Override
			public Adapter caseSelectByKind(SelectByKind object) {
				return createSelectByKindAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link anatlyzer.atlext.OCL2.SelectByKind <em>Select By Kind</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSelectByKindAdapter() {
		return null;
	}
