/**
 */
package anatlyzer.atlext.OCL2.util;
 ...
 * @generated
 */
public class OCL2Switch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static OCL2Package modelPackage;
	...
	public OCL2Switch() {
		if (modelPackage == null) {
			modelPackage = OCL2Package.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OCL2Package.SELECT_BY_KIND: {
				SelectByKind selectByKind = (SelectByKind)theEObject;
				T result = caseSelectByKind(selectByKind);
				if (result == null) result = caseCollectionOperationCallExp(selectByKind);
				if (result == null) result = caseOperationCallExp(selectByKind);
				if (result == null) result = casePropertyCallExp(selectByKind);
				if (result == null) result = caseOclExpression(selectByKind);
				if (result == null) result = caseLocatedElement(selectByKind);
				if (result == null) result = caseTypedElement(selectByKind);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Select By Kind</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Select By Kind</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelectByKind(SelectByKind object) {
		return null;
	}
