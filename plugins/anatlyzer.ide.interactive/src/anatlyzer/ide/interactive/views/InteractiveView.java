...
public class InteractiveView extends ViewPart implements IPartListener {
	 ...
	 */
	public static final String ID = "anatlyzer.ide.interactive.views.InteractiveView";
	...
	private InteractiveComposite impl;	 
	...
	public void createPartControl(Composite parent) {
		impl = new InteractiveComposite(parent, SWT.NONE);
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				InteractiveView.this.fillContextMenu(manager);
			}
		});
